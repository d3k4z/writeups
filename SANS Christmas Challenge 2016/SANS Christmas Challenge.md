...
Първата част от паролата вероятно е `santasli`, втората част от парола се намира в изтеглен bin файл от `/out.pcap` ![](images/secondhalf.png)
...
Докато си губих времето в разглеждане на функцийте на приложението видях, че липсват пакети към http://dev.northpolewonderland.com/
...
https://ads.northpolewonderland.com/ <- from app
Screenshot
